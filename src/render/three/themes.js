...
export const THEMES = Object.freeze({
  tournament: {
    ...
    board: {
      light: { kind: 'wood', color: 0xd9b98a, light: 0xe9d4b0, dark: 0xcaab7e, rings: 22, roughness: 0.58, clearcoat: 0.08, envMapIntensity: 0.4 },
      dark: { kind: 'wood', color: 0x63422a, light: 0x6d4a2c, dark: 0x51341e, rings: 20, roughness: 0.6, clearcoat: 0.08, envMapIntensity: 0.4 },
      frame: { kind: 'wood', color: 0x4a2f1c, light: 0x5a3a22, dark: 0x3d2413, rings: 14, angle: 1.2, roughness: 0.38, clearcoat: 0.4 },
      inlay: 0xd8c49a,
    },
    pieces: {
      white: { kind: 'wood', color: 0xe4d5b7, light: 0xeee0c4, dark: 0xcdb491, rings: 26, roughness: 0.42, clearcoat: 0.35, clearcoatRoughness: 0.3 },
  ...
  marble: {
    ...
    board: {
      light: { kind: 'marble', color: 0xece8de, base: 0xf3efe6, vein: 0xb9b2a2, roughness: 0.3, clearcoat: 0.35, clearcoatRoughness: 0.12, envMapIntensity: 0.55 },
      dark: { kind: 'marble', color: 0x3a3d45, base: 0x40444c, vein: 0x22252b, roughness: 0.32, clearcoat: 0.35, clearcoatRoughness: 0.14, envMapIntensity: 0.55 },
      frame: { kind: 'metal', color: 0x6b665a, roughness: 0.38, metalness: 0.85, envMapIntensity: 0.6 },
      inlay: 0xb9a97e,
    },
    pieces: {
      white: { kind: 'marble', color: 0xf5f2ea, base: 0xeae5da, vein: 0xc2bcac, roughness: 0.22, clearcoat: 0.6, clearcoatRoughness: 0.1 },
  ...
  obsidian: {
    ...
    board: {
      light: { kind: 'stone', color: 0x40474f, roughness: 0.4, metalness: 0.12, clearcoat: 0.3, envMapIntensity: 0.6 },
      dark: { kind: 'stone', color: 0x14181d, roughness: 0.42, metalness: 0.14, clearcoat: 0.3, envMapIntensity: 0.6 },
  ...
  emerald: {
    ...
    board: {
      ...
      frame: { kind: 'wood', color: 0x2f3a33, light: 0x3a4840, dark: 0x27332c, rings: 14, roughness: 0.5 },
      inlay: 0xe0d7c0,
    },
    pieces: {
  ...
  neon: {
    ...
    board: {
      light: { kind: 'plain', color: 0x2a1e63, roughness: 0.34, metalness: 0.35, emissive: 0x1b1145, emissiveIntensity: 0.2, envMapIntensity: 0.5 },
      dark: { kind: 'plain', color: 0x0a0619, roughness: 0.36, metalness: 0.4, emissive: 0x0a0620, emissiveIntensity: 0.15, envMapIntensity: 0.5 },
      frame: { kind: 'metal', color: 0x161034, roughness: 0.22, metalness: 1, emissive: 0x8c1a60, emissiveIntensity: 0.1 },
      inlay: 0x00e5ff,
    },
    pieces: {
      white: { kind: 'plain', color: 0x3fb9d6, roughness: 0.26, metalness: 0.45, emissive: 0x0a7fa8, emissiveIntensity: 0.35, clearcoat: 1 },
      black: { kind: 'plain', color: 0xb52d78, roughness: 0.28, metalness: 0.5, emissive: 0x8f0f57, emissiveIntensity: 0.35, clearcoat: 1 },
    },
    highlights: { ...HIGHLIGHTS_DEFAULT, selected: 0x00e5ff, legal: 0x7cff6b, lastMove: 0xffe14f, check: 0xff2f5e },
    post: { bloom: 0.5, bloomThreshold: 0.72, ssao: false },
  },
  ...
  ivory: {
    ...
    board: {
      light: { kind: 'marble', color: 0xefe4cd, base: 0xf4ead6, vein: 0xd2c1a0, roughness: 0.38, clearcoat: 0.3, envMapIntensity: 0.5 },
      dark: { kind: 'wood', color: 0x2b1d16, light: 0x372619, dark: 0x1f1510, rings: 20, roughness: 0.44, clearcoat: 0.28, envMapIntensity: 0.5 },
      frame: { kind: 'wood', color: 0x6b4a2c, light: 0x7d5533, dark: 0x553921, rings: 14, angle: 1.2, roughness: 0.34, clearcoat: 0.5 },
      inlay: 0xe8d3a8,
    },
    pieces: {
